...
LOG_FILE = os.environ.get("LOG_FILE", "/var/log/resource_monitor.log")
SCALE_SCRIPT = os.path.join(os.path.dirname(__file__), "..", "..", "cloud", "scripts", "scale_up.sh")
...
logger.error("Scale-up script timed out after 300s")
return False
